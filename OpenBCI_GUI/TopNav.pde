...
class TopNav {
    ...
    */
    ...
    private void createToggleAuxInputButton(String text, int _x, int _y, int _w, int _h, PFont font, int _fontSize, color _bg, color _textColor) {
        auxButton = createTNButton("toggleAuxInputButton", text, _x, _y, _w, _h, font, _fontSize, _bg, _textColor);
        auxButton.onRelease(new CallbackListener() {
            public void controlEvent(CallbackEvent theEvent) {
                auxInputButtonWasPressed();
            }
        });
        auxButton.setDescription("Press this button to Stop/Start the auxillary input process.");
    }
    ...
    private void createToggleEmgChannelsButton(String text, int _x, int _y, int _w, int _h, PFont font, int _fontSize, color _bg, color _textColor) {
    ...
    private void createToggleEogChannelsButton(String text, int _x, int _y, int _w, int _h, PFont font, int _fontSize, color _bg, color _textColor) {
